...
!define HELPURL "http://spinecha.in" # "Support Information" link
!define UPDATEURL "http://spinecha.in" # "Product Updates" link
!define ABOUTURL "http://spinecha.in" # "Publisher" link
...
Icon "logo.ico"
outFile "spinechain-installer.exe"
